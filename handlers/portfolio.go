...
var projects = map[string]Project{
	...
	"traver-hardwood-floors": {
		...
		NextSlug:         "406-records",
		NextClient:       "406 Records",
		Story: []string{
	...
	"406-records": {
		Slug:     "406-records",
		Client:   "406 Records",
		Title:    "A record label that sounds like it looks.",
		Subtitle: "Brand identity and marketing site for a Helena, Montana recording studio — built around the music, not a template.",
		Location: "Recording studio · Helena, MT",
		Tags:     []string{"Marketing site", "Brand", "Design"},
		LiveURL:          "https://406records.com",
		Screenshot:       "/static/images/portfolio/406records_screenshot.webp",
		ScreenshotMobile: "/static/images/portfolio/406records_screenshot_mobile.webp",
		NextSlug:         "western-skies",
		NextClient:       "Western Skies Contracting",
		Story: []string{
			"406 Records is a working musician's recording studio in Helena, Montana — engineering, producing, mixing, and mastering for local and regional artists. The founder has over 20 years behind instruments and boards. He needed a site that carried the same weight as the work coming out of the studio.",
			"The design splits the page in half — clean, editorial typography on a warm cream field, and a dark vinyl-record hero that rotates real album art. It reads like a label, not a landing page. The palette is restrained: black, cream, and a deep red accent that shows up only where it earns attention.",
			"The proof bar anchors the fold — 4 albums released, 24+ songs produced, 20+ years as a musician. No fluff metrics. Just the numbers that matter to an artist deciding where to record. The discography, services, and FAQ are all structured to answer the questions a prospective client actually has.",
		},
		Results: []ProjectResult{
			{Value: "4", Unit: "albums", Label: "Released through the studio"},
			{Value: "24", Unit: "+songs", Label: "Produced and mastered"},
			{Value: "20", Unit: "+yrs", Label: "Behind the boards"},
		},
		Deliverables: []string{
			"Custom marketing site — split-layout hero with vinyl record visual",
			"Brand identity — logo, color system, typography",
			"Full copywriting — services, about, FAQ, discography",
			"Responsive design — editorial mobile layout",
			"SEO foundation and metadata",
			"Hosting and SSL on Firefly infrastructure",
		},
	},
	"western-skies": {
