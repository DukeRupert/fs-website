	...
	<div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
		<div class="xl:grid xl:grid-cols-3 xl:gap-8">
			<div class="space-y-8">
				<img
					class="h-14 w-auto"
					src="/images/firefly/logo_two_small.png"
				...
				<div class="md:grid md:grid-cols-2 md:gap-8">
					<div>
						...
						<ul role="list" class="mt-6 space-y-4">
							...
							<li>
								<a href="#features" class="text-sm leading-6 text-gray-600 hover:text-gray-900"
									>Features</a
								>
							</li>
							<li>
								<a href="#pricing" class="text-sm leading-6 text-gray-600 hover:text-gray-900"
									>Pricing</a
								>
							</li>
						</ul>
					...
					<div class="mt-10 md:mt-0">
						...
						<ul role="list" class="mt-6 space-y-4">
							...
							<li>
								<a href="#" class="text-sm leading-6 text-gray-600 hover:text-gray-900">SEO</a>
							</li>
							<li>
								<a href="#" class="text-sm leading-6 text-gray-600 hover:text-gray-900"
									>Content Creation</a
		...
		<div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
			<p class="text-xs leading-5 text-gray-500">
				&copy; 2020 Firefly Software, LLC. All rights reserved.
			</p>
		</div>
	</div>
</footer>
